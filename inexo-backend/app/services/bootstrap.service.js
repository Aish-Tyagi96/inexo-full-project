  ...
  const newsEvents = [
    {
      ...
      description: 'INEXO Metal Casts successfully participated in a major industry exhibition, showcasing its advanced feeding systems and innovative casting solutions.',
    ...
    },
    {
      ...
      description: 'INEXO Metal Casts announces a new strategic partnership to expand its reach and deliver enhanced solutions to global markets.',
      fullDescription: "INEXO Metal Casts announces a new strategic partnership to expand its reach and deliver enhanced solutions to global markets. This collaboration brings together complementary strengths in engineering, manufacturing, and distribution, creating new opportunities for growth and innovation. The partnership aims to accelerate product development, improve supply chain efficiency, and open doors to new industry sectors. By joining forces with a trusted global partner, INEXO is poised to enhance its service offerings and deliver even greater value to customers worldwide.",
      imagePath: '/uploads/images/Social_Responsibility.png',
